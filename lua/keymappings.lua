...
map('n','<F5>',':UndotreeToggle<CR>',default_map)
...
map('n','<F6>',':NextColorScheme<CR>',default_map)
map('n','<F7>',':PrevColorScheme<CR>',default_map)

--Whickey
map('n','<silent> <space>',':silent Whickey \'<space>\'<CR>',default_map)
